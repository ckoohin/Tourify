...
router.post(
  ...
  [
    ...
    body('slug')
      ...
      .isLength({ max: 100 }).withMessage('Slug tối đa 100 ký tự'),
    body('description')
      .optional()
      .trim(),
    body('parent_id')
      .optional()
      .isInt().withMessage('Parent ID phải là số'),
    body('display_order')
      .optional()
...
router.put(
  ...
  [
    ...
    body('parent_id')
      .optional()
      .custom(value => value === null || Number.isInteger(parseInt(value)))
...
router.post(
  ...
  [
    body('orders')
      .isArray({ min: 1 }).withMessage('orders phải là mảng và không rỗng'),
    body('orders.*.id')
      .isInt().withMessage('ID phải là số'),
    body('orders.*.display_order')
      .isInt({ min: 0 }).withMessage('display_order phải là số >= 0')
  ],
